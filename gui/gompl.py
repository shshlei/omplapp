...
#        self.mainWidget.solveWidget.solveButton.clicked.connect(self.solve)
    ...
    def openConfig(self):
        ...
        if fname:
            ...
            if self.is3D:
                ...
                #print start().rotation().x, start().rotation().y, start().rotation().z, start().rotation().w
    ...
    def openConfigMulti(self):
        ...
        if fname:
            ...
            if sys.version_info > (3, 0):
                ...
                config = ConfigParser.ConfigParser()
            config.read([fname])
            if config.has_option("problem", "start1.z"):
                if config.has_option("problem", "control"):
                    ctype = config.get("problem", "control")
                    if ctype == "blimp":
                        robotType = [t[0] for t in self.robotTypes].index('GBlimpPlanning')
            ...
            self.robotFile = join(cfg_dir, config.get("problem", "robot1"))
            self.omplSetup.setRobotMesh(self.robotFile)
            self.mainWidget.glViewer.setRobot1(self.omplSetup.renderRobot())
            self.robotFile = join(cfg_dir, config.get("problem", "robot2"))
            self.omplSetup.setRobotMesh(self.robotFile)
            self.mainWidget.glViewer.setRobot2(self.omplSetup.renderRobot())
            self.robotFile = join(cfg_dir, config.get("problem", "robot3"))
            self.omplSetup.setRobotMesh(self.robotFile)
            self.mainWidget.glViewer.setRobot3(self.omplSetup.renderRobot())
            self.robotFile = join(cfg_dir, config.get("problem", "robot4"))
            self.omplSetup.setRobotMesh(self.robotFile)
            self.mainWidget.glViewer.setRobot4(self.omplSetup.renderRobot())

            self.resetBounds()
            if self.isGeometric:
                self.mainWidget.plannerWidget.geometricPlanning.resolution.setValue(
                    self.omplSetup.getSpaceInformation().getStateValidityCheckingResolution())
            start1 = ob.State(self.omplSetup.getGeometricComponentStateSpace())
            goal1 = ob.State(self.omplSetup.getGeometricComponentStateSpace())
            start2 = ob.State(self.omplSetup.getGeometricComponentStateSpace())
            goal2 = ob.State(self.omplSetup.getGeometricComponentStateSpace())
            if self.is3D:
                start1().setX(config.getfloat("problem", "start1.x"))
                start1().setY(config.getfloat("problem", "start1.y"))
                start1().setZ(config.getfloat("problem", "start1.z"))
                start1().rotation().setAxisAngle(config.getfloat("problem", "start1.axis.x"),
                                                config.getfloat("problem", "start1.axis.y"),
                                                config.getfloat("problem", "start1.axis.z"),
                                                config.getfloat("problem", "start1.theta"))
                goal1().setX(config.getfloat("problem", "goal1.x"))
                goal1().setY(config.getfloat("problem", "goal1.y"))
                goal1().setZ(config.getfloat("problem", "goal1.z"))
                goal1().rotation().setAxisAngle(config.getfloat("problem", "goal1.axis.x"),
                                               config.getfloat("problem", "goal1.axis.y"),
                                               config.getfloat("problem", "goal1.axis.z"),
                                               config.getfloat("problem", "goal1.theta"))
                start2().setX(config.getfloat("problem", "start2.x"))
                start2().setY(config.getfloat("problem", "start2.y"))
                start2().setZ(config.getfloat("problem", "start2.z"))
                start2().rotation().setAxisAngle(config.getfloat("problem", "start2.axis.x"),
                                                config.getfloat("problem", "start2.axis.y"),
                                                config.getfloat("problem", "start2.axis.z"),
                                                config.getfloat("problem", "start2.theta"))
                goal2().setX(config.getfloat("problem", "goal2.x"))
                goal2().setY(config.getfloat("problem", "goal2.y"))
                goal2().setZ(config.getfloat("problem", "goal2.z"))
                goal2().rotation().setAxisAngle(config.getfloat("problem", "goal2.axis.x"),
                                               config.getfloat("problem", "goal2.axis.y"),
                                               config.getfloat("problem", "goal2.axis.z"),
                                               config.getfloat("problem", "goal2.theta"))
            else:
                start1().setX(config.getfloat("problem", "start1.x"))
                start1().setY(config.getfloat("problem", "start1.y"))
                start1().setYaw(config.getfloat("problem", "start1.theta"))
                goal1().setX(config.getfloat("problem", "goal1.x"))
                goal1().setY(config.getfloat("problem", "goal1.y"))
                goal1().setYaw(config.getfloat("problem", "goal1.theta"))
                start2().setX(config.getfloat("problem", "start2.x"))
                start2().setY(config.getfloat("problem", "start2.y"))
                start2().setYaw(config.getfloat("problem", "start2.theta"))
                goal2().setX(config.getfloat("problem", "goal2.x"))
                goal2().setY(config.getfloat("problem", "goal2.y"))
                goal2().setYaw(config.getfloat("problem", "goal2.theta"))
            self.mainWidget.problemWidget.setStart1Pose(start1, self.is3D)
            self.mainWidget.problemWidget.setGoal1Pose(goal1, self.is3D)
            self.mainWidget.problemWidget.setStart2Pose(start2, self.is3D)
            self.mainWidget.problemWidget.setGoal2Pose(goal2, self.is3D)
            if self.is3D:
                if config.has_option("problem", "volume.min.x") and \
                   config.has_option("problem", "volume.min.y") and \
                   config.has_option("problem", "volume.min.z") and \
    ...
    def openPathMulti(self):
        ...
        if fname:
            ...
            for line in open(fname, 'r').readlines():
                ...
                if not l:
                    continue
                path = [float(x) for x in l.split(' ')]
                lenp = len(path)//2
                path1.append(path[:lenp])
                path2.append(path[lenp:])

            self.mainWidget.glViewer.solutionPath = []
            self.mainWidget.glViewer.solutionPath2 = []

            # assume that first 3 components map to SE(2) if 3<len<7
            if len(path1[0]) > 2 and len(path1[0]) < 7:
                self.path1 = [self._arrayToSE2State(s) for s in path1]
            elif len(path1[0]) >= 7:
                self.path1 = [self._arrayToSE3State(s) for s in path1]
            else:
                # unknown state type
                OMPL_ERROR("Wrong state format")
                raise ValueError
            if len(path2[0]) > 2 and len(path2[0]) < 7:
                self.path2 = [self._arrayToSE2State(s) for s in path2]
            elif len(path2[0]) >= 7:
                self.path2 = [self._arrayToSE3State(s) for s in path2]
            else:
                # unknown state type
                OMPL_ERROR("Wrong state format")
                raise ValueError
            self.mainWidget.glViewer.setSolutionPath(self.path1)
            self.mainWidget.glViewer.setSolutionPath2(self.path2)
            # setStart/GoalPose can change bounds, so save and restore them
            self.mainWidget.problemWidget.setStart1Pose(self.path1[0], self.is3D)
            self.mainWidget.problemWidget.setGoal1Pose(self.path1[-1], self.is3D)
            self.mainWidget.problemWidget.setStart2Pose(self.path2[0], self.is3D)
            self.mainWidget.problemWidget.setGoal2Pose(self.path2[-1], self.is3D)
    ...
    def loadPlannerData(self):
        ...
        if fname:
            pd = ob.PlannerData(ob.SpaceInformation(self.omplSetup.getGeometricComponentStateSpace()))
            pds= ob.PlannerDataStorage()
            pds.load(fname, pd)
            self.pd = pd
    ...
    def createActions(self):
        ...
        self.openConfigMultiAct = QtWidgets.QAction('Open Problem &Multi Configuration', self, \
            shortcut='Ctrl+Shift+O', statusTip='Open a multi problem configuration (.cfg file)', \
            triggered=self.openConfigMulti)
        ...
        self.openPathMultiAct = QtWidgets.QAction('&Open Multi Path', self, \
            shortcut='Ctrl+Shift+Alt+O', statusTip='Open a path', \
            triggered=self.openPathMulti)
    ...
    def createMenus(self):
        ...
        self.fileMenu.addAction(self.openConfigMultiAct)
        self.fileMenu.addAction(self.saveConfigAct)
        self.fileMenu.addAction(self.openPathAct)
        self.fileMenu.addAction(self.openPathMultiAct)
...
class MainWidget(QtWidgets.QWidget):
    def __init__(self, robotTypes, parent=None, flags=QtCore.Qt.WindowFlags(0)):
        ...
        self.problemWidget.startChanged.connect(self.glViewer.setStart1Pose)
        self.problemWidget.goalChanged.connect(self.glViewer.setGoal1Pose)
        self.problemWidget.startChanged2.connect(self.glViewer.setStart2Pose)
        self.problemWidget.goalChanged2.connect(self.glViewer.setGoal2Pose)
...
class GLViewer(QOpenGLWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.startPose2 = [0, 0, 0, 0, 0, 0]
        self.goalPose2 = [0, 0, 0, 0, 0, 0]
        self.solutionPath = None
        self.solutionPath2 = None
        self.pathIndex = 0
    ...
    def setGoalPose(self, value):
        ...
        self.updateBounds(value[3:])
        self.update()
    def setStart1Pose(self, value):
        self.startPose = value
        self.updateBounds(value[3:])
        self.update()
    def setGoal1Pose(self, value):
        self.goalPose = value
        self.updateBounds(value[3:])
        self.update()
    def setStart2Pose(self, value):
        self.startPose2 = value
        self.updateBounds(value[3:])
        self.update()
    def setGoal2Pose(self, value):
        self.goalPose2 = value
        self.updateBounds(value[3:])
        self.update()
    ...
    def setSolutionPath(self, path):
        ...
        self.pathIndex = 0
        self.update()
    def setSolutionPath2(self, path):
        self.solutionPath2 = [self.getTransform(state()) for state in path]
        self.pathIndex = 0
        self.update()
    ...
    def setRobot1(self, robot):
        if self.robot1:
            gl.glDeleteLists(self.robot1, 1)
        self.robot1 = robot
    def setRobot2(self, robot):
        if self.robot2:
            gl.glDeleteLists(self.robot2, 1)
        self.robot2 = robot
    def setRobot3(self, robot):
        if self.robot3:
            gl.glDeleteLists(self.robot3, 1)
        self.robot3 = robot
    def setRobot4(self, robot):
        if self.robot4:
            gl.glDeleteLists(self.robot4, 1)
        self.robot4 = robot
    ...
    def initializeGL(self):
        ...
        #gl = QOpenGLContext.currentContext().versionFunctions(profile)
    ...
    def paintGL(self):
        ...
        if self.robot2:
            # draw goal pose
            self.transform(self.goalPose)
            gl.glCallList(self.robot2)
            gl.glPopMatrix()

        if self.robot3:
            self.transform(self.startPose2)
            gl.glCallList(self.robot3)
            gl.glPopMatrix()

            # draw path pose(s)
            if self.solutionPath2 is not None:
                if self.animate:
                    gl.glPushMatrix()
                    gl.glMultMatrixf(self.solutionPath2[self.pathIndex])
                    gl.glCallList(self.robot3)
                    gl.glPopMatrix()
                else:
                    n = len(self.solutionPath2)
                    nmax = 100
                    if n < nmax:
                        ind = range(0, n)
                    else:
                    ...
                    for i in ind:
                        gl.glPushMatrix()
                        gl.glMultMatrixf(self.solutionPath2[i])
                        gl.glCallList(self.robot3)
                        gl.glPopMatrix()

        if self.robot4:
            # draw goal pose
            self.transform(self.goalPose2)
            gl.glCallList(self.robot4)
            gl.glPopMatrix()
        ...
        for ellipse in self.ellipses:
            gl.glCallList(ellipse)

        for certificate in self.certificates:
            gl.glCallList(certificate)
...
#        gl.glOrtho(-5.00, +5.00, -5.00, +5.00, 1.0, 1000.0)
    ...
    def ellipse(self, rx, ry, x0, y0, theta):
        ...
        dt = 2 * pi / num
        for i in range(100):
            gl.glVertex3d(x0 + cos(theta) * rx * cos(i*dt) - sin(theta) * ry * sin(i * dt),
    ...
    def sphere(self, x0, y0, z0, r):
        ...
        for i in range(num):
            ...
            for j in range(num):
                ...
                for k in range(4):
                    gl.glVertex3f(x0+x[k], y0+y[k], z0+z[k])
...
class ProblemWidget(QtWidgets.QWidget):
    ...
    startChanged2 = Signal(list)
    goalChanged2 = Signal(list)
    ...
    def setStart1Pose(self, value, is3D):
        self.startPose2D.setPose(value, is3D)
        if is3D:
            self.elevation2D.setValue(value().getZ())
        self.startPose3D.setPose(value, self.elevation2D.value(), is3D)
    def getStart1Pose(self):
        return self.startPose3D.getPose() \
            if self.poses.currentIndex() == 0 else self.startPose2D.getPose()
    def setGoal1Pose(self, value, is3D):
        self.goalPose2D.setPose(value, is3D)
        if is3D:
            self.elevation2D.setValue(value().getZ())
        self.goalPose3D.setPose(value, self.elevation2D.value(), is3D)
    def getGoal1Pose(self):
        return self.goalPose3D.getPose() \
            if self.poses.currentIndex() == 0 else self.goalPose2D.getPose()

    def setStart2Pose(self, value, is3D, robot = 1):
        self.startPose2D.setPose(value, is3D, robot)
        if is3D:
            self.elevation2D.setValue(value().getZ())
        self.startPose3D.setPose(value, self.elevation2D.value(), is3D, robot)
    def getStart2Pose(self):
        return self.startPose3D.getPose() \
            if self.poses.currentIndex() == 0 else self.startPose2D.getPose()
    def setGoal2Pose(self, value, is3D, robot = 1):
        self.goalPose2D.setPose(value, is3D, robot)
        if is3D:
            self.elevation2D.setValue(value().getZ())
        self.goalPose3D.setPose(value, self.elevation2D.value(), is3D, robot)
    def getGoal2Pose(self):
        return self.goalPose3D.getPose() \
            if self.poses.currentIndex() == 0 else self.goalPose2D.getPose()
    ...
    def startPoseChange(self, value):
        ...
        if value[6] == 0:
            self.startChanged.emit(value[0:6])
        else:
            self.startChanged2.emit(value[0:6])
    def goalPoseChange(self, value):
        if self.poses.currentIndex() == 1:
            value[5] = self.elevation2D.value()
        if value[6] == 0:
            self.goalChanged.emit(value[0:6])
        else:
            self.goalChanged2.emit(value[0:6])
...
class Pose3DBox(QtWidgets.QGroupBox):
    ...
    def __init__(self, title):
        ...
        layout = QtWidgets.QGridLayout()
        layout.addWidget(poslabel, 0, 1, QtCore.Qt.AlignCenter)
        layout.addWidget(rotlabel, 0, 2, QtCore.Qt.AlignCenter)
    ...
    def setPose(self, value, elevation, is3D, robot = 0):
        self.robot = robot
        state = value()
        if is3D:
...
#            self.roty.setValue(rad2deg * asin(max(min(2.*(q.w*q.y-q.z*q.x), 1.), -1.)))
    ...
    def poseChange(self, _):
        self.valueChanged.emit([self.rotx.value(), self.roty.value(), self.rotz.value(), \
            self.posx.value(), self.posy.value(), self.posz.value(), self.robot])
        self.robot = 0
...
class Pose2DBox(QtWidgets.QGroupBox):
    ...
    def __init__(self, title):
        ...
        layout = QtWidgets.QGridLayout()
        layout.addWidget(xlabel, 0, 0, QtCore.Qt.AlignCenter)
        layout.addWidget(ylabel, 1, 0, QtCore.Qt.AlignCenter)
        layout.addWidget(rotlabel, 2, 0, QtCore.Qt.AlignCenter)
    ...
    def setPose(self, value, is3D, robot = 0):
        self.robot = robot
        state = value()
        if is3D:
            self.posx.setValue(state.getX())
    ...
    def poseChange(self, _):
        self.valueChanged.emit([0, 0, self.rot.value(), self.posx.value(), self.posy.value(), 0, self.robot])
...
class BoundsWidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        layout.addWidget(self.resetButton, 2, 0, QtCore.Qt.AlignCenter)
        self.setLayout(layout)
...
class BoundsBox(QtWidgets.QGroupBox):
    ...
    def __init__(self, title):
        ...
        layout = QtWidgets.QGridLayout()
        layout.addWidget(xlabel, 1, 0, QtCore.Qt.AlignCenter)
        layout.addWidget(ylabel, 2, 0, QtCore.Qt.AlignCenter)
        layout.addWidget(zlabel, 3, 0, QtCore.Qt.AlignCenter)
        layout.addWidget(self.posx, 1, 1)
        layout.addWidget(self.posy, 2, 1)
        layout.addWidget(self.posz, 3, 1)
        self.setLayout(layout)
