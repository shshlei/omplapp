...
namespace ompl
{
    namespace app
    {
        ...
        /// @brief Wrapper for ompl::app::RigidBodyPlanning that plans for multiple rigid bodies in Realvector2.
        class RealVector2MultiRigidBodyPlanning : public AppBase<AppType::GEOMETRIC>
        {
        public:
            ...
            RealVector2MultiRigidBodyPlanning(unsigned int n);

            ~RealVector2MultiRigidBodyPlanning() override = default;
